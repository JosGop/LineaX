...
class GradientAnalysisScreen(tk.Frame):
    ...
    def _get_unit_conversion_factor(self, from_unit: str) -> float:
        """Return the SI conversion factor for the given unit string."""
    ...
    def create_gradient_section(self, parent):
        ...
        tk.Label(inner, text="From Best Fit:", font=("Segoe UI", 9),
    ...
    def calculate_comparison(self):
        ...
        try:
            ...
            if percentage_diff < 5:
                ...
                interpretation, color = "Good! Your result is reasonably close to the accepted value.", "#d97706"
            else:
                interpretation, color = "Your result differs significantly. Check your experimental method.", "#dc2626"
