"""
LinearGraphDisplay.py

Displays the linearised graph with best fit and worst fit lines alongside
statistical analysis results and Excel-style chart element customisation.
"""
...
class LinearGraphResultsScreen(tk.Frame):
    """Displays linear regression analysis with best/worst fit lines and results panels."""
    ...
    def create_graph(self):
        """Draw data points, best fit, and worst fit lines on a matplotlib figure."""
    ...
    def _create_error_layout(self):
        ...
        tk.Label(err, text="⚠️", font=("Segoe UI", 48), bg="white", fg="#dc2626").pack(pady=(100, 20))
